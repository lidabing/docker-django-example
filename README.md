...
**This app is using Django 4.2.7 and Python 3.11.5**. The screenshot doesn't get
...
2. 使用 `docker ps` 命令查看所有正在运行的 Docker 容器。这个命令会显示每个容器的 ID、镜像、命令、创建时间、状态、端口和名称。

```bash
docker ps
```

3. 找到你想要查看控制台的容器的 ID 或名称。
